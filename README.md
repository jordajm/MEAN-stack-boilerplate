...
- `gulp serve-specs`
    ...
    Serves and browses to the spec runner html page and runs the unit tests in it. Injects any changes on the fly and re runs the tests. Quick and easy view of tests as an alternative to terminal view `gulp test`.
...
- `gulp autotest`
    ...
    Runs a wach to run all unit tests.
...
- `gulp wiredep`
    ...
    The `.bowerrc` fil also runs this as a postinstall task whenever `bower install` is run.
